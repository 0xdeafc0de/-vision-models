...
A continuation of the [perceptron](https://github.com/0xdeafc0de/perceptron) learning project, exploring how neural networks generalize to different image classification tasks. This repository demonstrates that the same architecture and training techniques work across different domains — from MNIST digits to fashion items.
